    ...
    if self.canInput then
        ...
        if love.keyboard.wasPressed('enter') or love.keyboard.wasPressed('return') then
            ...
            elseif math.abs(self.highlightedTile.gridX - x) + math.abs(self.highlightedTile.gridY - y) > 1 then
                ...
                --local tempTile = self.board.tiles[self.highlightedTile.gridY][self.highlightedTile.gridX]
                ...
                --if self:calculateMatches() ~= false then
                    ...
                    :finish(function()
                        if self.board:calculateMatches() ~= false then
                            ...
                            --3.4 check if there are any possible matches, if not then reset
                            if self.board:checkForNoMatches() == false then
...
function PlayState:calculateMatches()
    ...
    -- if no matches, we can continue playing
        ...
        self.canInput = true
        --3.4 return false if no matches
